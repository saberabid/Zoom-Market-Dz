        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
          <div className="flex items-center gap-4 text-slate-300 font-medium">
            ...
            <span className="hidden md:flex items-center gap-1">
              ...
              Paiement 100% à la livraison (COD)
            </span>
          </div>
          ...
          <div className="flex items-center gap-4 text-slate-300 font-medium text-[11px]">
            ...
            >
              ...
              <span>Service Client: <strong className="text-white">{storePhone || '0550 00 00 00'}</strong></span>
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={onOpenAdmin}
              className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-brand-navy hover:text-white dark:hover:bg-brand-orange dark:hover:text-white rounded-xl transition-all shadow-sm border border-slate-200 dark:border-slate-700"
            ...
            {/* Email Config Modal Trigger */}
            <button
              onClick={onOpenEmailConfig}
              className="p-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors"
              title="Configuration EmailJS / WhatsApp"
            >
